...
function App() {
  ...
  const handleRegistro = (event) => {
    ...
    /*
    axios.post('http://localhost:5000/NPersona', nuevaPersona)
      .then(response => {
    ...
    */
    ...
    /*
    axios.post('http://localhost:5000/NUsuario', nuevoUsuario)
      .then(response => {
        ...
        {!isLoged ? (
          <div className="texto-centrado">
            <div>
              {showButtons && (
              <div>
                <h3>Todas las pantallas desarrolladas en este código serán usadas por la Secretaria o el Médico Imageneólogo.</h3>
                <h3>Pues son ellos los que tomarán un rol administrativo y gestionaran las citas.</h3>  
                <h3>Falta corregir errores a la hora de modificar citas realizando solicitudes a la base de datos, y corregir casos borde como evitar registrar 2 veces al mismo usuario</h3>
                <h3>(arrojara error al tener 2 documentos con un mismo atributo que se supone que es unico) </h3>
                <h3>Por último se añadió la pantalla de visualizar horas que permite cumplir con la HU4, así como también la HU1 que permite almacenar el rut de la persona que añadio una hora</h3>
